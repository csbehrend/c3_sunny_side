...
# Very evil source code modifications for global constants
...
func get_scene_string(state: GameState) -> String:
	match (state):
		GameState.STATE_MENU:
			return ""
		GameState.STATE_CREDITS:
			return ""
		GameState.STATE_PLAY_1:
			return ""
		GameState.STATE_RESULTS_1:
			return ""
		GameState.STATE_PLAY_2:
			return ""
		GameState.STATE_RESULTS_2:
			return ""
		GameState.STATE_PLAY_3:
			return ""
		GameState.STATE_RESULTS_3:
			return ""
		GameState.STATE_PLAY_4:
			return ""
		GameState.STATE_RESULTS_4:
			return ""
		GameState.STATE_PLAY_5:
			return ""
...
@onready var max_round: int = 1
@onready var game_state: GameState = GameState.STATE_PLAY_1
